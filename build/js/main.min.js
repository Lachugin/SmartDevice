...
/* harmony import */ var _modules_modals_accordion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/accordion */ "./js/modules/modals/accordion.js");
/* harmony import */ var _modules_modals_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/scroll */ "./js/modules/modals/scroll.js");
/* harmony import */ var _modules_modals_spoiler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/spoiler */ "./js/modules/modals/spoiler.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_scroll__WEBPACK_IMPORTED_MODULE_3__["scroll"])();
  Object(_modules_modals_spoiler__WEBPACK_IMPORTED_MODULE_4__["spoiler"])();
  Object(_modules_modals_accordion__WEBPACK_IMPORTED_MODULE_2__["accordion"])(); // Modules
  // ---------------------------------
...
var accordion = function accordion() {
  var listItems1 = document.getElementById('listToggle1');
  var buttonClose1 = document.getElementById('btnToggle1');
  var listItems2 = document.getElementById('listToggle2');
  var buttonClose2 = document.getElementById('btnToggle2');
  buttonClose1.addEventListener('click', function (e) {
    e.preventDefault();
    listItems1.classList.toggle('footer__list--open');
  });
  buttonClose2.addEventListener('click', function (b) {
    b.preventDefault();
...
var scroll = function scroll() {
  var smoothLinks = document.querySelector('.header__btn');
  smoothLinks.addEventListener('click', function (e) {
    e.preventDefault();
    var id = smoothLinks.getAttribute('href');
...
var spoiler = function spoiler() {
  var textSpan = document.querySelector('.about__text-none');
  var textBoxNone = document.querySelector('.about__box-none');
  var buttonBoxText = document.querySelector('.about__btn');
