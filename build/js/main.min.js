...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_3__["scroll"])();
  Object(_modules_spoiler__WEBPACK_IMPORTED_MODULE_4__["spoiler"])();
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_2__["accordion"])(); // Modules
  // ---------------------------------
...
var spoiler = function spoiler() {
  var textSpan = document.querySelectorAll('.about__js-open');
  var buttonBoxText = document.querySelector('.about__btn');
  var textBoxNone = document.querySelector('.about__box-no-js');
  textBoxNone.classList.remove('about__box-no-js');

  var _iterator = _createForOfIteratorHelper(textSpan),
      _step;

  try {
    var _loop = function _loop() {
      var itemsText = _step.value;
